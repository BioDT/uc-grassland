...
# Define observation data specifications for selected eLTER sites
OBSERVATION_DATA_SPECS_PER_SITE = MappingProxyType(
    {
        ...
        "31e67a47-5f15-40ad-9a72-f6f0ee4ecff6": {
            "name": "LTSER Zone Atelier Armorique",
            "variables": ["cover", "indices"],  # indices NOT USED CURRENTLY
        ...
        "KUL-site": {
            ...
            "observation_columns": {
                "cover": "default",
                "management": None,
            },  # Note: specific management info "years since last mowing management" could be used, but not clear how
            "pft_lookup_files": {
        ...
        "4c8082f9-1ace-4970-a603-330544f22a23": {
            ...
            "observation_columns": {
                "cover": "default",
                "management": None,
            },  # site-specific management data handled by prep_management_data get_CZ_CVL_data
            "pft_lookup_files": {
...
SPECIES_DATA_SPECS_PER_SITE = MappingProxyType(
    {
        ...
        "6b62feb2-61bf-47e1-b97f-0e909c408db8": {
            ...
            "extra_columns": [
                []
            ],  # Note: [["TAXA_ALT"]] could be used, but needs code adjustment as TAXA column can have duplicates then
        },
        # NOT USED CURRENTLY
        # "829a2bcc-79d6-462f-ae2c-13653124359d": {
        #     "name": "Ordesa y Monte Perdido / Huesca ES",
